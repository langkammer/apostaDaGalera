...
export class BottonButtonGrupoByMembroComponent implements OnInit {

  ngOnInit(): void {
    console.log("INICIALIZAOU SUB MENU BOTTON")
  }

  constructor(private _bottomSheetRef: MatBottomSheetRef<BottonButtonGrupoByMembroComponent>) {
  }
